...
export default function UserHome() {
    ...
    const filterAreas = areas.filter((area) => {
        return area.name.toLowerCase().includes(searchField.toLowerCase());
    });

    // Navigate to the specific area page when an area is clicked
    const onAreaClick = (areaName) => {
        ...
        <>
            ...
            <div className="homePage">
                <div className="section section1">
                    <div className="miningBox">Mining Areas</div>
                    <SearchBox searchField={searchField} onSearchChange={onSearchChange} />
                </div>
                <div className="section section2">
                    <div className="pictureBox">
                        <AreaList areaList={filterAreas} onAreaClick={onAreaClick} />
                    </div>
                </div>
            </div>
        </>
